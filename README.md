...
5. Add fan handling depending on the temperature of the CPU/GPU (~~Add simple fan handling with fixed speed~~) Completed on Nov 6, 2020
7. Add ramdisk and manage saved files from there (left as the last modification)

## Dependencies and/or extra software needed

1. sshpass
2. rsync (Optional)
3. OpenSSH server
4. Jetson-GPIO (Optional -> leds, buttons)
